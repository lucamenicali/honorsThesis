...
var
    ...
    f_ttt, pi_star, z1t, z2t, rt, c_f_start, lt, tau_kt, kdy, st;
...
// 30. Endogenous capital tax
    exp(tau_kt) / tau_k = ( exp(lt(-1)) / l_ss )^(gamm_kl) * ( exp(y_ht) / y_h_ss )^(gamm_ky);
...
osr_params gamm_kl gamm_ky phi_R phi_s;
